...
# This script assumes the Human Human Activity Recognition (HAR) Using Smartphones
#   Dataset was downloaded, files extracted, and the working directory is the
#   HAR parent directory.  Uncomment the first section if files were not
#   previously downloaded.

## download dataset - uncomment if dataset is not already downloaded
...
HAR_tidy
setwd("..")
write.table(HAR_tidy, row.names = FALSE, "HAR_tidy.txt")
